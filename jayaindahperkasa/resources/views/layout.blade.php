...
<head>
    ...
    <title>Dashboard - CV Jaya Indah Perkasa</title>
...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ url('') }}" class="logo d-flex align-items-center">
            <span class="d-none d-lg-block">Jaya Indah Perkasa</span>
        </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#barang-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Menu Barang</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            ...
            <ul id="transaksi-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('transaksi.index') }}">
                        <i class="bi bi-circle"></i><span>Order Transaksi</span>
                    </a>
                </li>
                <li>
